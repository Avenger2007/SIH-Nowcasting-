...
[![Tests](https://img.shields.io/badge/tests-61_passing-1E8E52?style=flat-square)](tests/test_pipeline.py)
...
tests/test_pipeline.py     61 tests; regression tests name the bug they guard
```
...
**32 issues tracked · 28 resolved · 4 open with documented next steps.**
